...
export ISSM_DIR="$HOME/r-arobel3-0/ISSM"
...
./configure \
    ...
    --with-mpi-libflags="-L${ISSM_DIR}/externalpackages/petsc/install/lib -lmpi -lmpichcxx -lmpifort" \
...
wget -O src/m/classes/clusters/generic.m \
    https://raw.githubusercontent.com/ICESEE-project/ICESEE/refs/heads/develop/applications/issm_model/issm_utils/slurm_cluster/generic_cluster.m
